...
const { contactInquiryTemplate, generalContactTemplate } = require('../utils/emailTemplates');
...
module.exports = { createContactCtrl, getContactsByVendorCtrl, getUserInquiryByIdCtrl, createGeneralContactCtrl };