...
const VendorRegister = () => {
  ...
  const isCurrentVerified = isPhoneVerified && verifiedNumber === (hasWhatsApp ? watch("whatsappNumber") : watch("phone"));
  ...
  useEffect(() => {
    const activeNumber = hasWhatsApp ? watch("whatsappNumber") : watch("phone");
    if (activeNumber !== verifiedNumber) {
      setOtpSent(false);
      setOtp('');
    }
  }, [watch("phone"), watch("whatsappNumber"), hasWhatsApp, verifiedNumber]);
  ...
  const handleVerifyOTP = async () => {
    ...
    if (result.success) {
      ...
      setVerifiedNumber(hasWhatsApp ? whatsappNum : phoneNumber);
      setOtpSent(false);
      setOtp('');
    }
